...
import com.patterns.electronics.ItemManagementPage
import com.patterns.electronics.R
import com.squareup.picasso.Picasso

class managerAdapter(val items : ArrayList<Item>) : RecyclerView.Adapter<managerAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        v.setOnClickListener {
            val i = Intent(v.context, ItemManagementPage::class.java)
